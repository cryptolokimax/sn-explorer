  ...
  return (
    ...
    <Box align="center" justify="stretch" pad="small" background={{ color: 'accent-1' }} round="medium" direction="column" margin={{ left: 'large' }}>
      ...
      <Text>
              (in
        {' '}
        {nextRewardDuration.days() ? ((nextRewardDuration.days() * 24) + nextRewardDuration.hours()) : nextRewardDuration.hours()}
        {' '}
hrs
        {' '}
        {nextRewardDuration.minutes()}
        {' '}
min)
      </Text>
    </Box>
